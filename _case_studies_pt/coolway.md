...
gallery:
  - type: image
    ...
    alt: "Campanha Coolway, modelo no calçadão de Copacabana"
    wide: true
  - type: video
    src: /assets/video/coolway-rio.mp4
    poster: /assets/img/coolway-video-poster.jpg
  - type: image
    src: /assets/img/COOLWAY-100.jpg
    alt: "Campanha Coolway, modelo em uma quadra de futebol do Rio"
  - type: image
    src: /assets/img/COOLWAY-49.jpg
    alt: "Campanha Coolway, retrato editorial em uma escada"
gallery_bottom:
  - type: image
    src: /assets/img/COOLWAY-19.jpg
    alt: "Campanha Coolway, luz da manhã no calçadão"
  - type: image
    src: /assets/img/COOLWAY-32.jpg
    alt: "Campanha Coolway, street style em Copacabana"
  - type: image
    src: /assets/img/COOLWAY-55.jpg
    alt: "Campanha Coolway, detalhe do calçado"
  - type: image
    src: /assets/img/COOLWAY-62.jpg
    alt: "Campanha Coolway, em movimento na quadra"
  - type: image
    src: /assets/img/COOLWAY-76.jpg
    alt: "Campanha Coolway, retrato nas ruas"
  - type: image
    src: /assets/img/COOLWAY-89.jpg
    alt: "Campanha Coolway, look na golden hour"
credits:
